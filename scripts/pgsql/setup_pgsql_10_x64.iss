...
#define AppVersion      GetFileVersion('..\..\_dstdir\pgsql-10-x64\bin\psql.exe')
#define AppName         "Varlet PostgreSQL 10"
#define DBServiceName   "VarletPgSQL10"
#define DBRootPassword  "secret"
#define DBServicePort   "5432"
#define DBDataDirectory "{commonappdata}\Varlet\PostgreSQL-10\data"
...
[Files]
Source: "{#BasePath}_dstdir\pgsql-10-x64\*"; DestDir: {app}; Flags: ignoreversion recursesubdirs
...
const AppFolder = '\Varlet\PostgreSQL-10';
var
