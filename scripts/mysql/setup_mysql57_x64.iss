...
#define AppVersion      GetFileVersion('..\..\_dstdir\mysql-5.7-x64\bin\mysql.exe')
...
[Files]
Source: "{#BasePath}_dstdir\mysql-5.7-x64\*"; DestDir: {app}; Flags: ignoreversion recursesubdirs
